  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="color-blue fw-500">power</span> and{" "}
        <span className="color-blue fw-500">scalability</span> of the cloud to
      ...
      >
        With this service, you'll have access to a range of cloud-based tools
        ...
        <span className="color-blue fw-500">manage</span> your cloud strategy.
      </Typography>
    </Box>
  );
}
