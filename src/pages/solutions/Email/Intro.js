...
export default function Intro({ id }) {
  return (
    ...
    >
      ...
      >
        Our Email Security service is designed to help organizations protect
        their employees and data from the{" "}
        <span className="color-red fw-500">growing threat</span> of email-based
        attacks.
      </Typography>
